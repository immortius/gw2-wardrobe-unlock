...
import au.net.immortius.wardrobe.processors.ColorMatcher;
import au.net.immortius.wardrobe.processors.DataCacher;
import au.net.immortius.wardrobe.processors.IconCacher;
import au.net.immortius.wardrobe.processors.IconMatcher;
import au.net.immortius.wardrobe.processors.IdResolver;
import au.net.immortius.wardrobe.processors.ThumbnailGenerator;
...
import au.net.immortius.wardrobe.entities.Config;
import au.net.immortius.wardrobe.entities.IconConfig;

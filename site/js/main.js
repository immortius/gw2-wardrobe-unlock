...
var acquisitionMethods = [
    ...
    { id : "gold", name : "Coins", category : "Core", hideOnIcon : true},
    { id : "karma", name : "Karma", category : "Core"},
    { id : "laurel", name : "Laurel", category : "Core"},
    { id : "spiritshard", name : "Spirit Shard", category : "Core", hideOnIcon : true},
    { id : "globofectoplasm", name : "Glob of Ectoplasm", category : "Core", hideOnIcon : true},
    { id : "guildcommendation", name : "Guild Commendation", category : "Core"},
    { id : "provisionertoken", name : "Provisioner Token", category : "Core"},
    { id : "swimspeedinfusion", name : "Swim-Speed Infusion", category : "Core"},
    { id : "racingmedallion", name : "Racing Medallion", category : "Core"},
    //{ id : "proofoflegend", name : "Proof of Legend", category : "Core"},
    ...
    { id : "karkashell", name : "Karka Shell", category : "Living World Season 1 / 2"},
    { id : 'banditcrest', name : "Bandit Crest", category : "Living World Season 1 / 2"},
    //{ id : 'mordrembloom', name : "Mordrem Bloom", category : "Living World Season 1 / 2"},
